...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('ORFK',0,'','Kadét, 20,'{}','{}'),
	('ORFK',1,'őrmester,'ormester','{}'),
	('ORFK',2,''Törzsőrmester,),
	('ORFK',3,'Zászlós','Lieutenant',85,'{}','{}'),
	('ORFK',4,'Hadnagy','Commandant',100,'{}','{}')
	('ORFK',5,'Százados','Commandant',100,'{}','{}')
	('ORFK',6,'Őrnagy','Commandant',100,'{}','{}')
	('ORFK',7'Alezredes,'Commandant',100,'{}','{}')
    ('ORFK',8,''Dandártábornok,'Commandant',100,'{}','{}')
	('ORFK',9,''Vezérőrnagy,'Commandant',100,'{}','{}')
	('ORFK',10,'Főnök','Commandant',100,'{}','{}')
...
INSERT INTO `fine_types` (label, amount, category) VALUES
	...
	('Entrave opération de ORFK',130,1),
	('Insulte envers / entre civils',75,1),
	('Outrage à agent de ORFK',110,1),
